...
<body style="background-image: url('background.jpg');background-repeat: ;background-size: 100%,100%" >
        <section id="nav-bar">
            <nav class="navbar navbar-expand-lg navbar-light ">
                ...
                <a class="navbar-brand" href="index.php"><img src="logo.jpg" style="height:40px" ></a>
                    <ul class=" navbar-nav navbar-right" >
                        <li class="nav-item"><a href="help1.php" style="color:gray"><strong>Request for Code</strong></a></li>
    ...
    <div class="container">
    	<div class="row">
            <div class="col-md-8 offset-md-2 form-div help">
                ...
                <h1 class="text-center">Request Code</h1>
            ...
            <label for="phone">Why do you require the code?</label>
