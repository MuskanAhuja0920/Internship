    ...
    <div class="container">
    	<div class="row">
            ...
            <div class="form-group">
                <p  style="font-size:25px"><strong> Download Code:</strong></p>
            </div>
            <div class="form-group">
                <a href="webapp.zip" class="button" download="webapp.zip" style="margin:auto;display:block" ><i class="fa fa-download"></i> Download</button></a>

           
                </div>
            <div class="form-group">
                <p style="font-size:25px"><strong>Download Database:</strong></p>
            </div>

            <div class="form-group">
                <a href="userverification.zip" download="userverification.zip" class="button" style="margin:auto;display:block" ><i class="fa fa-edit"></i>Download</button></a>
